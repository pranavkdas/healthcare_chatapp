            ...
            "properties": {
                ...
                "response": {
                    ...
                    "properties": {
                        ...
                        "policy_start_date": {
                            "type": "string",
                            "description": "The start date of the policy in YYYY-MM-DD format. It represents a date that comes before policy_end_date",
                        },
                        "policy_end_date": {
                            "type": "string",
                            "description": "The end date of the policy in YYYY-MM-DD format. It represents a date that comes after policy_start_date",
                        },
                        "payer_name": {
                            "type": "string",
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "emirates_id": {
                    "type": "string",
                    "description": "The Emirates ID of the individual. Should satisfy this regex: ^[1–9][0-9]{14}$ (ie it should be a 15-digit unique identifier). It cannot be empty or contain placeholder text like redacted, invalid, xxx etc",
                },
                "name": {
                    "type": "string",
                    "description": "The full name of the individual.",
